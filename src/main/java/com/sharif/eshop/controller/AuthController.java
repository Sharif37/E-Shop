...
import com.sharif.eshop.request.LoginRequest;
import com.sharif.eshop.security.jwt.JwtUtils;
import com.sharif.eshop.security.user.ShopUserDetailsService;
import com.sharif.eshop.utils.CookieUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> refreshAccessToken(HttpServletRequest request){
        cookieUtils.logCookieNames(request);
